...
🛠️ Kurulum (Installation)Projeyi yerel ortamınızda çalıştırmak için aşağıdaki adımları izleyin:Repoyu bilgisayarınıza klonlayın:Bashgit clone [https://github.com/KULLANICI_ADINIZ/RoboTeach.git](https://github.com/KULLANICI_ADINIZ/RoboTeach.git)
cd RoboTeach
